              ...
              {data.icon && (
                <LibIcon
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(90deg, #1d0425ff 0%, #190320ff 100%)', // Add this line for the linear gradient background
                    color: '#9112BC', // Add this line for text color
