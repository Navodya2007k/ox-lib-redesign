  ...
  return (
    <>
      <Modal
        ...
        style={{background: 'radial-gradient(circle, rgba(19, 19, 19, 0.67) 0%, rgba(19,19,19,0.6544818611038166) 50%)',
      }}
        onClose={() => {
          setOpened(false);
          closeAlert('cancel');
      ...
      <ReactMarkdown>{dialogData.header}</ReactMarkdown>
          ...
          <Group position="right" spacing={10}>
            {dialogData.cancel && (
              <Button
                ...
                backgroundColor: 'red',
                '&:hover': {
                backgroundColor: '#ce1d1dff', // hover color
                },
              }}
            uppercase
            variant="light"
        ...
        >
          {dialogData.labels?.cancel || locale.ui.cancel}
            ...
            <Button
              uppercase 
              style={{clipPath: 'polygon(0 5%, 100% 0, 100% 100%, 0 95%)',borderRadius:'1px', backgroundColor:'green'  }}
