  ...
  return (
    <>
      ...
      <Modal
        ...
        style={{background: 'radial-gradient(circle, rgba(19, 19, 19, 0.66) 0%, rgba(19,19,19,0.6544818611038166) 50%)',
      }}
        ...
        <form  onSubmit={onSubmit}>
          <Stack> 
            ...
            <Group position="right" spacing={10}>
              ...
              <Button uppercase   style={{clipPath: 'polygon(0 5%, 100% 0, 100% 100%, 0 95%)',borderRadius:'1px', backgroundColor:'green' }}  type="submit">
                {locale.ui.confirm}
              </Button>
            </Group>
          </Stack>
